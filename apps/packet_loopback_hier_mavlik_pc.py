...
# Title: Packet Loopback Hier Mavlik Pc
...
class packet_loopback_hier_mavlik_pc(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Packet Loopback Hier Mavlik Pc")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Packet Loopback Hier Mavlik Pc")
        ...
        self.settings = Qt.QSettings("GNU Radio", "packet_loopback_hier_mavlik_pc")
        ...
        self.zeromq_sub_source_0 = zeromq.sub_source(gr.sizeof_gr_complex, 1, 'tcp://127.0.0.1:14001', 100, False, -1, '')
        self.zeromq_sub_msg_source_0 = zeromq.sub_msg_source('tcp://127.0.0.1:14000', 100, False, '')
        self.zeromq_pub_sink_0 = zeromq.pub_sink(gr.sizeof_gr_complex, 1, 'tcp://127.0.0.1:14002', 100, False, -1, '')
        ...
        self.msg_connect((self.uaslink_mavlink_control_0, 'MAVLink_OUT'), (self.packet_tx_0, 'in'))
...
def main(top_block_cls=packet_loopback_hier_mavlik_pc, options=None):
