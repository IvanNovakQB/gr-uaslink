...
# Title: Packet Loopback Hier Mavlink Pi3
# Description: Packet Based version which would run on the RPI3
...
class packet_loopback_hier_mavlink_pi3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Packet Loopback Hier Mavlink Pi3")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Packet Loopback Hier Mavlink Pi3")
        ...
        self.settings = Qt.QSettings("GNU Radio", "packet_loopback_hier_mavlink_pi3")
        ...
        self.zeromq_sub_source_0 = zeromq.sub_source(gr.sizeof_gr_complex, 1, 'tcp://127.0.0.1:14002', 100, False, -1, '')
        self.zeromq_pub_sink_0 = zeromq.pub_sink(gr.sizeof_gr_complex, 1, 'tcp://127.0.0.1:14001', 100, False, -1, '')
        ...
        self.channels_channel_model_0 = channels.channel_model(
            ...
            noise_seed=0,
            block_tags=True)
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_gr_complex*1, 300000,True)
        ...
        self.msg_connect((self.packet_rx_0, 'pkt out'), (self.uaslink_pymavlink_source_sink_pp_0, 'MAVLink_IN'))
...
def main(top_block_cls=packet_loopback_hier_mavlink_pi3, options=None):
