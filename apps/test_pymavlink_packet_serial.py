...
# Title: Test Pymavlink Packet Serial
...
class test_pymavlink_packet_serial(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Test Pymavlink Packet Serial")
        ...
        self.uaslink_pymavlink_source_sink_pp_1 = uaslink.pymavlink_source_sink_pp('/dev/ttyUSB0',57600)
...
def main(top_block_cls=test_pymavlink_packet_serial, options=None):
    tb = top_block_cls()
